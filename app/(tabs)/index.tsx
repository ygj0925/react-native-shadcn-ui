          ...
          {QUICK_LINKS.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href as never} asChild>
                <Button
                  variant="ghost"
                  className="h-auto justify-start rounded-2xl border border-border bg-card px-0 py-0">
                  <Card className="w-full border-0 py-0 shadow-none">
                    <CardHeader className="flex-row items-center justify-between px-5 pb-2 pt-5">
